        ...
        <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header animated fadeInDown"><br>
			<center>
                ...
                <i style="color: red;font-size: .8rem">
                    * กรุณากรอกข้อมูลให้ครบถ้วน <br>
                    เพื่อความสะดวกในการติดตามสินค้า
                </i>
			</center>

            <div class="row m-0 mt-3 text-center" id="box1" style="display:none">
                <div class="col-12 mb-2">
                    <div class="card">
                        <div class="card-body">
                            <i>* กรุณากรอกข้อมูลสมาชิกให้ครบถ้วนก่อนใช้บริการค่ะ *</i><br><br>

                            <a href="<?php echo base_url();?>liff/member">
                                <button class="btn btn-primary mt-3">กรอกข้อมูล</button>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row m-0 mt-3" id="box2" style="display:block">
                <div class="col-12 mb-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3">
                                        <input type="hidden" class="form-control" name="insertLineID" id="lineID">
                                        <input type="hidden" class="form-control" name="insertUserID" id="userID">

                                        <div class="form-floating mb-3">
                                            <select class="form-select form-control" name="insertBrand" required>
            ...
            // ================= Line liff ===================
                function runApp() {
                    liff.getProfile().then(profile => {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '<?php echo base_url();?>liff/service/checkCust',
                ...
                liff.init({ liffId: "1656240710-mdXq0rXl" }, () => {
                    if (liff.isLoggedIn()) {
                        runApp()
                    } 
                    else {
