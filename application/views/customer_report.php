...
<head>
    ...
    <title>P E R S O N A L &nbsp;R E P O R T | W E B &nbsp; M A N A G E</title>
        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                        ...
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">
                                    <div class="col-6">เลือกรายชื่อ</div>
                                </div>   
                                <div class="card-body">
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="selectName" 
                                        onchange="selectName()" aria-label="Floating label select example">
                                            <?php 
                                                if(!empty($_GET['selected'])){ 
                                                    $userIDSelect = $_GET['selected'];
                                                    $dataUser = $this->Report_model->selectDataUser($userIDSelect);
                                                    echo "<option value='".$dataUser->user_id."'>".$dataUser->user_name."</option>";
                                                }else{
                                                    echo "<option value=''>เลือกรายชื่อลูกค้า</option>";
                                                }
                                        ...
                                        <label for="floatingSelect">รายชื่อลูกค้า:</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        function selectName(){
                            window.location.href = 'customer_report?selected='+$('#selectName').val();
                        }
                    </script>
                    ...
                    ?>
                        <div class="row m-0" >
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">
                                        <div class="col-6">รายงานบุคคล</div>
                                    </div>   
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <?php
                                                    if(!empty($_GET['date'])){
                                                        ...
                                                        if($selectDate == 'all'){
                                                ?>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=all"><button class="btn-wide btn mr-2 btn-info">ทั้งหมด</button></a>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=today&value=<?php echo date('Y-m-d');?>"><button class="btn-wide btn mr-2">วันนี้</button></a>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=month&value=<?php echo date('Y-m');?>"><button class="btn-wide btn mr-2">เดือนนี้</button></a>
                                                <button class="btn-wide btn mr-2" id="selectDateShow" onclick='showInputDate()'>เลือกวันที่แสดง</button>
                                                <?php 
                                                        }else if($selectDate == 'today'){
                                                ?>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=all"><button class="btn-wide btn mr-2">ทั้งหมด</button></a>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=today&value=<?php echo date('Y-m-d');?>"><button class="btn-wide btn mr-2 btn-info">วันนี้</button></a>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=month&value=<?php echo date('Y-m');?>"><button class="btn-wide btn mr-2">เดือนนี้</button></a>
                                                <button class="btn-wide btn mr-2" id="selectDateShow" onclick='showInputDate()'>เลือกวันที่แสดง</button>
                                                <?php
                                                ...
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=all"><button class="btn-wide btn mr-2">ทั้งหมด</button></a>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=today&value=<?php echo date('Y-m-d');?>"><button class="btn-wide btn mr-2">วันนี้</button></a>
                                                <a href="?selected=<?php echo $userIDSelect; ?>&date=month&value=<?php echo date('Y-m');?>"><button class="btn-wide btn mr-2 btn-info">เดือนนี้</button></a>
                                                <button class="btn-wide btn mr-2" id="selectDateShow" onclick='showInputDate()'>เลือกวันที่แสดง</button>
                                                <?php
                                                ...
                                                ?><br><br>
                                                                <div id="showInputDate" class='animated fadeInRight'>
                                                                    <form action="customer_report" method="get">
                                                                        <input type="hidden" name="date" value="1">
                                                                        <input type="hidden" name="selected" value="<?php echo $userIDSelect; ?>">
